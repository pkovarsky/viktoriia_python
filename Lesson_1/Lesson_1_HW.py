...
#('T', 'h', 'e', ' ', 'w', 'a', 'y', ' ', 't', 'o', ' ', 'g', 'e', 't', ' ', 's', 't', 'a', 'r', 't', 'e', 'd', ' ', 'i', 's', ' ', 't', 'o', ' ', 'q', 'u', 'i', 't', ' ', 't', 'a', 'l', 'k', 'i', 'n', 'g', ' ', 'a', 'n', 'd', ' ', 'b', 'e', 'g', 'i', 'n', ' ', 'd', 'o', 'i', 'n', 'g', '.')

sliced = my_tuple[-5:-25:-1]
#('o', 'd', ' ', 'n', 'i', 'g', 'e', 'b', ' ', 'd', 'n', 'a', ' ', 'g', 'n', 'i', 'k', 'l', 'a', 't')

unique = set(sliced)
#{'t', 'g', 'd', 'l', 'i', 'a', ' ', 'k', 'o', 'e', 'n', 'b'}

my_dict = {}.fromkeys(unique)
#{'t': None, 'g': None, 'd': None, 'l': None, 'i': None, 'a': None, ' ': None, 'k': None, 'o': None, 'e': None, 'n': None, 'b': None}
...
my_set = {"name", "formula", False, ("C", "H", "O", "N"), "SI", 2, False, 0.0001}
